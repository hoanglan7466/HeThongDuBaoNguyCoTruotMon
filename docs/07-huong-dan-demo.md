...
6. Mở cảnh báo, cập nhật trạng thái; xem báo cáo và xuất CSV.
7. Mở trang model và `/health` để chứng minh trạng thái thật.

Trong suốt demo phải nhắc rõ dữ liệu và metrics hiện tại dùng synthetic dataset.
